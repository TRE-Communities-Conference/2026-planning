We are applying the Code of Conduct used by [RCM Cooperative](http://rcmcooperative.com/)
...
Restorative Practice Principles and Disciplines should guide the community in creating a safe, friendly and enjoyable space for collaboration and support.
...
**7.1** This Code of Conduct applies to all community members participating in the activities, events and processes taking place within or organised by and on behalf of the **TRE Communities Conference**. 
Specifically, our Code of Conduct applies to any conduct:
- in interactions within the TRE Communities Conference
- at any TRE Communities Conference communication or event
- outside TRE Communities Conference activity when an organising member is representing projects associated with the TRE Communities Conference.

**7.2** This Code of Conduct also applies to individuals outside the TRE Communities Conference officially representing the community in public spaces.

Examples of representing the TRE Communities Conference include using an official e-mail address, posting via an official social media account, or acting as an appointed a representative at an online or offline event.

**7.3** This Code of Conduct also applies to individuals engaging with this repository for instance, in interactions on GitHub issues and Pull Requests or activities taking place in the context of the TRE Communities Conference.
...
Event organisers are responsible for clarifying and enforcing our standards of acceptable behaviour and will take appropriate and fair corrective, restorative and action in response to any behaviour that they deem inappropriate, threatening, offensive,
or harmful.

Event organisers have the right and responsibility to remove, edit, or reject comments, commits, code, edits, issues, and other contributions that are not aligned to this Code of Conduct, and will communicate reasons for moderation decisions when appropriate.

## 9. Enforcement

Instances of trolling, harassing, abusive, or otherwise unacceptable behaviour should be reported to the event organisers responsible for enforcement.
If noticed by event organisers, incidents should be recorded and shared with one or more members of the RCM Cooperative for transparency.

All reports will be reviewed and investigated promptly and fairly.

All event organisers are obligated to respect the privacy and security of the reporter of any incident.
...
If you experience or witness unacceptable behaviour, or have any other concerns, please report it by contacting one the named event organisers below. They will involve another member of the Governance Committee when any potential conflict of interest with any of them may arise.

Event organisers:
- Cassandra Gould van Praag (cassandra.gouldvanpraag@rcmcooperative.com)
- <mark>Event organiser 2</mark>
- <mark>Event organiser 3</mark>
...
After receiving a report, the event organisers (or person handling the report), team lead or programme director, in this case, will review the incident report and follow this process to determine the cause and consequences that violated this Code of Conduct and take further actions:

### **12.1** If the breach is considered within the scope of this Code of Conduct

Event organisers will reach out to the reporter to ask for further information if the submitted report is not complete or needs some additional context.
Event organisers will also ensure that the person impacted or harmed by the reported incident is safe and identifies how they can be further supported.
...
1. a private communication from event organisers, providing clarity around the nature of the violation and an explanation of why the
